from openai import AsyncOpenAI, APIConnectionError, RateLimitError, AuthenticationError, BadRequestError, APIStatusError
from typing import List, Optional
from app.models.schemas import Commit, PullRequest

DEFAULT_PROMPT = """Generate a professional resume-ready summary using bullet points. Focus on the MOST SIGNIFICANT contributions:
